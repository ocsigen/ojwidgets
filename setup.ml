...
(* OASIS_START *)
(* DO NOT EDIT (digest: fe2f0d4bce950dfb8dbef32ee10eea65) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Scrollbar_f"; "jcrop/Jcrop"];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\138\252e\131\020\133\229\029O\221\145.\225\144U[";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
