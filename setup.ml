...
(* OASIS_START *)
(* DO NOT EDIT (digest: 15f8078acc131aaaad23d8f004d59f29) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("ojwidgets-api", OCamlbuildDocPlugin.doc_build "src")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("ojwidgets-api", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\147¼@ú8Ð>7¥\151)»\006%×ù";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
