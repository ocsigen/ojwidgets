...
(* OASIS_START *)
(* DO NOT EDIT (digest: 07488486b396cb0084e2d880161edc54) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("ojwidgets-api", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("ojwidgets-api", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
                 ...
                 ({
                      ...
                      },
                   {
                      ...
                      lib_internal_modules =
                        ["Option"; "Base"; "Ojw_list"; "Size"];
                      lib_findlib_parent = Some "ojwidgets";
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["jcrop/Jcrop"];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Ojwidgets";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "´{\tPµç\002y\030%\026\022\131\003\0141";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
