...
(* OASIS_START *)
(* DO NOT EDIT (digest: ba936f5459a70929585997eb6a7fda0e) *)
(*
...
let setup_t =
  {
                      ...
                      },
                   {
                      lib_modules =
                        [
                           ...
                           "Ojw_mobile_tools";
                           "Ojw_position";
                           "experimental/Ojw_base_widget";
                           "experimental/Ojw_active_set";
                           "experimental/Ojw_event";
                           "experimental/Ojw_alert_f";
                           "experimental/Ojw_alert";
                           "experimental/Ojw_button_f";
                           "experimental/Ojw_button";
                           "experimental/Ojw_dropdown_f";
                           "experimental/Ojw_dropdown";
                           "experimental/Ojw_traversable_f";
                           "experimental/Ojw_traversable";
                           "experimental/Ojw_completion_f";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "4\238\208\214\149F\"8v?$\224\127/\252\203";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
