(* OASIS_START *)
(* DO NOT EDIT (digest: e5b600ffcdfb6a81eca58eaae9e9f9a5) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ...
          ("ojwidgets", ["src"; "src/experimental"], [])
       ];
     lib_c = [];
     flags = [];
     includes =
       [
          ("src/jcrop", ["src"; "src/experimental"; "src/internals"]);
          ("src/internals", ["src/base"]);
          ("src/experimental", ["src"; "src/internals"; "src/jcrop"]);
          ("src", ["src/experimental"; "src/internals"; "src/jcrop"])
       ]
  }
  ;;
...
let () =
  try
    ...
    tag_file "ojwidgets-api.wikidocdir/index.wiki" ["apiref";"wikidoc"];
